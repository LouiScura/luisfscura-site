    ...
    <AuthenticatedLayout>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex mt-12">
                ...
                <div class="flex-1">
                    <div>
                        <h1 class="text-white text-xl font-semibold">Create a category!</h1>
                    </div>
                    ...
                    <form @submit.prevent="store">
                        <div class="mb-6">
                            ...
                            <input v-model="form.name" class="text-gray-200 bg-custom-admin-bg rounded-xl border border-custom-border my-2 p-3 w-96" type="text" name="name" id="name" required />
