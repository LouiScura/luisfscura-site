...
const handleFileChange = (event) => {
    ...
    if (file) {
        form.image = file;
        console.log('File selected:', file); // This will help you see if the file is being selected correctly
    }
            ...
            <div class="flex mt-12">
                ...
                <div class="flex-1">
                    ...
                    <form @submit.prevent="update">
                        ...
                        <div class="mb-6">
                            <label class="block font-bold text-sm text-gray-200 mt-6" for="slug"> Slug </label>
                        ...
                        <div class="mb-6">
                            ...
                            <div v-if="form.errors.image" v-text="form.errors.image" ref="fileInput" class="text-red-500 text-xs mt-1"></div>
